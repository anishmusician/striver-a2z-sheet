...
export const LoginPage: React.FC<LoginPageProps> = ({ onLoginSuccess }) => {
  ...
  return (
    <div className="min-h-screen w-full bg-[#f8fafc] flex flex-col items-center justify-center p-4 relative overflow-hidden font-firaSans text-slate-900 selection:bg-orange-500/20">
      {/* Background Decorative Glow */}
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-gradient-to-tr from-orange-400/10 via-amber-300/10 to-transparent rounded-full blur-3xl pointer-events-none" />

      {/* Main Container */}
      <div className="w-full max-w-md relative z-10 animate-fadeIn">
        {/* Brand Header */}
        <div className="text-center mb-6">
          <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-white border border-slate-200 shadow-md mb-3.5">
          ...
          <div className="flex items-center justify-center gap-1.5 mt-1.5">
            <span className="text-xs px-2.5 py-0.5 rounded-full bg-orange-50 text-orange-700 border border-orange-200 font-semibold flex items-center gap-1">
        ...
        <div className="bg-white border border-slate-200 rounded-2xl shadow-xl p-6 sm:p-7">
          {/* Tab Switcher */}
          <div className="flex p-1 bg-slate-100 border border-slate-200 rounded-xl mb-6 text-xs font-semibold">
            <button
              type="button"
          ...
          {activeTab === 'signin' ? (
            <form onSubmit={handleLogin} className="space-y-4">
              <div>
                ...
                <div className="relative flex items-center">
                  ...
                  <input
                    ...
                    className="w-full pl-9 pr-3 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-xs text-slate-900 placeholder:text-slate-400 focus:bg-white focus:outline-none focus:ring-1 focus:ring-orange-500 font-mono shadow-xs"
                    required
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative flex items-center">
                  ...
                  <input
                    ...
                    placeholder="••••••••"
                    className="w-full pl-9 pr-10 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-xs text-slate-900 placeholder:text-slate-400 focus:bg-white focus:outline-none focus:ring-1 focus:ring-orange-500 font-mono shadow-xs"
                    required
                  />
                  <button
                    type="button"
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full py-2.5 px-4 bg-orange-600 hover:bg-orange-700 text-white rounded-xl text-xs font-bold transition-all shadow-md shadow-orange-500/20 flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50 mt-2"
              >
              ...
              <div className="pt-3 border-t border-slate-100 space-y-2">
                ...
                <div className="grid grid-cols-2 gap-2">
                  <button
                    ...
                    disabled={isLoading}
                    className="flex items-center justify-center gap-1.5 py-2 px-3 bg-orange-50 hover:bg-orange-100 border border-orange-200 text-orange-800 rounded-xl text-xs font-semibold transition-all cursor-pointer shadow-xs hover:scale-[1.02] disabled:opacity-50"
                  >
                  ...
                  <button
                    ...
                    disabled={isLoading}
                    className="flex items-center justify-center gap-1.5 py-2 px-3 bg-purple-50 hover:bg-purple-100 border border-purple-200 text-purple-800 rounded-xl text-xs font-semibold transition-all cursor-pointer shadow-xs hover:scale-[1.02] disabled:opacity-50"
                  >
            ...
            <form onSubmit={handleRegister} className="space-y-3.5">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-xl text-xs text-slate-900 placeholder:text-slate-400 focus:bg-white focus:outline-none focus:ring-1 focus:ring-orange-500 shadow-xs"
                  required
                />
              </div>
              ...
              <div>
                ...
                <div className="flex items-center bg-slate-50 border border-slate-200 rounded-xl px-3 py-2 text-xs focus-within:bg-white focus-within:ring-1 focus-within:ring-orange-500 shadow-xs">
                  ...
                  <input
                    ...
                    className="w-full bg-transparent text-slate-900 focus:outline-none font-mono text-xs placeholder:text-slate-400"
                    required
                  />
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-2">
                <div>
                  ...
                  <input
                    ...
                    placeholder="••••••••"
                    className="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-xl text-xs text-slate-900 placeholder:text-slate-400 focus:bg-white focus:outline-none focus:ring-1 focus:ring-orange-500 font-mono shadow-xs"
                    required
                  />
                </div>
                <div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 bg-orange-50/60 border border-orange-200 rounded-xl text-xs text-orange-950 focus:bg-white focus:outline-none focus:ring-1 focus:ring-orange-500 font-mono uppercase shadow-xs"
                  required
                />
                <p className="text-[10px] text-slate-500 mt-1">
                  Ask Anish for the invite passcode (e.g. <code className="text-orange-600 font-semibold">STRIKER-DSA-2026</code>). Random people cannot register without this key.
                </p>
              </div>

              {/* Avatar Color */}
              <div>
                <label className="text-xs font-semibold text-slate-700 block mb-1.5">Avatar Color</label>
